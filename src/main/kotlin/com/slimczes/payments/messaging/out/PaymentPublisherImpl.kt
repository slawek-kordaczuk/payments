...
@Component
internal class PaymentPublisherImpl(
    ...
    override fun publishPaidEvent(paidEvent: PaidEvent) {
    ...
    override fun publishPaidFailedEvent(paidFailedEvent: PaidFailedEvent) {
